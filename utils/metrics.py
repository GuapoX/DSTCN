...
class WIoU_Scale:
    ...
    @classmethod
    def _scaled_loss(cls, self, gamma=2.7, delta=1):
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=True, Focal=False, alpha=1, gamma=0.5, scale=False, eps=1e-7):
